...
Invoke a library API function from the command-line:
    ...
    $ clojure -X com.phronemophobic.desk.playground/foo :a 1 :b '"two"'
...
Your library will be deployed to com.phronemophobic.desk/playground on clojars.org by default.
